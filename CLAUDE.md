...
- **Design review gate (Dan, 2026-07-04):** visual/design changes are PRESENTED to Dan before the push, every time — render the proposal (live-tab injection with real art, or a sheet in assets/) and get the verdict first. Implementing is fine; shipping unseen is not. (Violated once on the Take-12 batch; Dan caught it.)
...
**Session pacing (Dan, 2026-07-04):** the session runs until Dan ends it — his official sign-off is "Goodnight, Claude." Claude never suggests wrapping up, winding down, or sleeping; after completing a task, stay engaged and ready for the next thing rather than closing with farewell energy.
