...
- **Pace discipline (Dan, 2026-07-03):** don't rush toward the next phase. Work isn't "done" until Dan has validated it in his hands; close responses with verification prompts and open questions, not next-step momentum. Depth over speed as beta approaches — no stone unturned. The BETA-READINESS.md checklist governs the path to release; items move to done only with explicit validation.
